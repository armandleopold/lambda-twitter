...
public final class TwitterKafkaProducer {
    TwitterKafkaProducer() {
        ...
        twitterStream.user();
        System.out.println("**********  Kafka Twitter-Producer Started");
    }

    private static final UserStreamListener listener = new UserStreamListener() {
        @Override
        public void onStatus(Status status) {
            System.out.println("**********  Kafka Twitter-Producer **********  onStatus @" + status.getUser().getScreenName() + " - " + status.getText());
            ...
            producer.send(new ProducerRecord<String, String>("twitterData", status.getText()));
